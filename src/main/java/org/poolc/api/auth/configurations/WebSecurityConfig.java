...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.POST, "/activity/session/check-in/*").hasAuthority(MemberRole.MEMBER.name())
                .antMatchers(HttpMethod.POST, "/activity/session/*/qr").hasAuthority(MemberRole.MEMBER.name())
                .antMatchers(HttpMethod.GET, "/activity/session/*/qr").hasAuthority(MemberRole.MEMBER.name())
                .antMatchers(HttpMethod.DELETE, "/activity/session/*/qr").hasAuthority(MemberRole.MEMBER.name())
